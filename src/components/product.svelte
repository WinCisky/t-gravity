<script lang="ts">
	...
	const clientId =
		'Aa8zMMxnb1NiwTIbw64BhpgP53K87uw7R3kRqVtSaGkuEgiuY8Qz3oEP2V3A1UQc3rDVrZyD5mATNZsK';
								...
								const response = await fetch(`${backendUrl}/create-paypal-order`, {
									...
									body: JSON.stringify({
										...
										cart: [
											{
												id: productId,
												proprieties: Object.fromEntries(selectedProprieties.entries())
											}
										]
									})
								});
				...
				<div class="mt-6">
					...
					<div class="space-y-6 text-base text-gray-700">
						<p>
							...
							and spacious bag. The zip top and durable canvas construction keeps your goods
